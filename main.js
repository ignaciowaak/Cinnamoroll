var Snake = (function () {
  ...
  var fixedTail = false; // Permitir que la serpiente crezca
  var intervalID;
  ...
  headImage.src = '1.jpg'; // Ruta de la imagen que querés usar como cabeza

  var fruitImage = new Image();
  fruitImage.src = '2.png'; // Ruta de la imagen que querés usar como fruta

  var backgroundImage = new Image();
  backgroundImage.src = '3.jpg'; // Ruta de la imagen que querés usar como fondo
  ...
  var game = {
    reset: function () {
      ctx.drawImage(backgroundImage, 0, 0, canv.width, canv.height); // Dibuja el fondo
    ...
    loop: function () {
      ...
      ctx.drawImage(headImage, trail[trail.length - 1].x * gridSize + 1, trail[trail.length - 1].y * gridSize + 1, gridSize - 2, gridSize - 2);

      if (player.x == fruit.x && player.y == fruit.y) {
        tail++; // Incrementa la longitud de la serpiente al comer una fruta
        points++;
